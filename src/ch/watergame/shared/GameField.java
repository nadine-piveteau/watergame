...
public class GameField implements Serializable {
	public enum FieldType {
		...
		TEE(30, 20, 0, 0, 3, -2, 0), TEEBIO(30, 20, 0, 1, 3, 1, 0), RICE(30, 20, 0, 0, 3, -2, 0), RICEBIO(30, 20, 0, 1, 3, 1, 0), ZUCKER(30, 20, 0,
				0, 3, -2, 0), ZUCKERBIO(30, 20, 0, 1, 3, 1, 0), FISCH(30, 20, 0, 0, 3, -2, 0), FISHBIO(30, 20, 0, 1,3, 1, 0), LEDER(50, 60, 0, 0, 5, -5, 0), 
				LEDERBIO(50,60,0,2,5,2,0), TEXTIL(50, 60, 0, 1, 5, -3, 0), TEXTILBIO(50,60,0,1,5,2,0),IT(60, 70, 0, 1, 6, -3, 0), ITBIO(60,70,0,1,6,1,0),
				SIEDLUNG(0, 0, 0, 0, 0, -1, 100), SIEDLUNGBIO(0,0,0,0,0,0,50), UNTERSTUFE(0, 0, 20, 2, 0, 0,
	...
	void setGameFieldforPlayer(int playerId) {
		...
		if(playerId==3){
			...
			gameField[6][8] = FieldType.UNTERSTUFE;

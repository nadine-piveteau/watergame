...
public class ValidatorHandler implements ClickHandler {
	...
	public Trade prepareTrade1(){
		...
		String importGood = waterGame.exportList1
		...
		Trade trade = new Trade(waterGame.getPlayerID(), 1,
	...
	public Trade prepareTrade4(){
		...
		String importGood = waterGame.exportList4
				.getItemText(importGoodIndex);
		int exportGoodIndex = waterGame.exportList4.getSelectedIndex();
		String exportGood = waterGame.exportList4
				.getItemText(exportGoodIndex);
		Trade trade = new Trade(waterGame.getPlayerID(), 4,
				importAmount, importGood, exportAmount, exportGood);
		return trade;
	}
	
	public boolean checkTrade1(){
		System.out.println("ExportAMountText1: "+ waterGame.exportAmountText1.getText());
		System.out.println("Export Good: "+ waterGame.exportList1.getValue(waterGame.exportList1.getSelectedIndex()));
		System.out.println("Empty check: "+(waterGame.exportAmountText1.getText().equals("")));
		if(!waterGame.exportAmountText1.getText().equals("")){
			int exportAmountRessource = Integer.parseInt(waterGame.exportAmountText1.getText());
			String exportAmountString = waterGame.exportList1.getValue(waterGame.exportList1.getSelectedIndex());
	...
	public boolean checkTrade2(){
		if(!waterGame.exportAmountText2.getText().equals("")){
			int exportAmountRessource = Integer.parseInt(waterGame.exportAmountText2.getText());
			String exportAmountString = waterGame.exportList2.getValue(waterGame.exportList2.getSelectedIndex());

		if(exportAmountString.contains("Reis")){
			System.out.println("Export: REIS");
			System.out.println("Reis vorher: "+ this.rize);
			System.out.println("Reis nacher: "+ (this.rize-exportAmountRessource));
	...
	public boolean checkTrade3(){
		if(!waterGame.exportAmountText3.getText().equals("")){
			int exportAmountRessource = Integer.parseInt(waterGame.exportAmountText3.getText());
			String exportAmountString = waterGame.exportList3.getValue(waterGame.exportList3.getSelectedIndex());
	...
	public boolean checkTrade4(){
		if(!waterGame.exportAmountText4.getText().equals("")){
			int exportAmountRessource = Integer.parseInt(waterGame.exportAmountText4.getText());
			String exportAmountString = waterGame.exportList4.getValue(waterGame.exportList4.getSelectedIndex());
			if(exportAmountString.contains("Reis")){
			System.out.println("Export: REIS");
			if((this.rize-exportAmountRessource)>=0){
				this.rize = this.rize-exportAmountRessource;
	...
	public void onClick(ClickEvent event) {
		...
		if (!waterGame.importAmountText1.getText().equals("")
				&& !waterGame.exportAmountText1.getText().equals("")&&checkTrade1) {
		...
		if (!waterGame.importAmountText2.getText().equals("")
				&& !waterGame.exportAmountText2.getText().equals("")&&checkTrade2) {
		...
		if (!waterGame.importAmountText3.getText().equals("")
				&& !waterGame.exportAmountText3.getText().equals("")&&checkTrade3) {
		...
		if (!waterGame.importAmountText4.getText().equals("")
				&& !waterGame.exportAmountText4.getText().equals("")&&checkTrade4) {
		...
		/*
			...
			Window.alert("Handel mit Spieler 1 nicht möglich. Du hast nicht genügend Ressourcen.");
		}else if(!checkTrade2){
			Window.alert("Handel mit Spieler 2 nicht möglich. Du hast nicht genügend Ressourcen.");
		}else if(!checkTrade3){
			Window.alert("Handel mit Spieler 3 nicht möglich. Du hast nicht genügend Ressourcen.");
		}else if(!checkTrade4){
			Window.alert("Handel mit Spieler 4 nicht möglich. Du hast nicht genügend Ressourcen.");
		}*/
	}
